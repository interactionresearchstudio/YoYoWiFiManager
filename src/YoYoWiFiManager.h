...
#include "YoYoWiFiManager/YoYoWiFiManagerSettingsInterface.h"
...
class YoYoWiFiManager : public AsyncWebHandler {
  ...
  private:
    ...
    YoYoWiFiManagerSettingsInterface *settings = NULL;
    uint8_t wifiLEDPin;
  ...
  public:
    ...
    void init(YoYoWiFiManagerSettingsInterface *settings, voidCallbackPtr onConnectedHandler = NULL, jsonCallbackPtr getHandler = NULL, jsonCallbackPtr postHandler = NULL, bool startWebServerOnceConnected = false, int webServerPort = 80, uint8_t wifiLEDPin = 2);
